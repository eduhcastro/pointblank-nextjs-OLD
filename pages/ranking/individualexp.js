...
import {ExpList,PaginacaoUsers} from '../../components/Componente.HeaderReact'
        	...
        	<div className="sub_contents_pnone">
				<div className="sub_tab_many_line">
					<ul className="sub_tab_many sub_tab_four <!--sub_tab_three-->">
                        ...
                        <li className="first"><Link href="/ranking/individualmatchs" ><a className="btn">MATCHS</a></Link></li>
